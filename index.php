                    ...
                    <div class="col-lg-3">
                        <div class="top_right_header">
                            ...
                            <ul class="top_right"> 
                                ...
                                <li class="cart"><a href="empty-cart.html"><i class="icon-handbag icons"></i></a></li>
                                <li class="h_price">
                    ...
                    <div class="l_product_slider owl-carousel">
                        <div class="item">
                            <div class="l_product_item">
                                <div class="l_p_img">
                                    <a href="product-details3.html"><img src="img/product/l-product-1.png" alt=""></a>
                                </div>
                                <div class="l_p_text">
                                    <ul>
                                        <li><a class="add_cart_btn" href="#">Adicionar ao Carrinho</a></li>
                                    </ul>
                                    <h4>Camiseta Lunattic</h4>
                                    <h5><del>R$45.50</del>  R$40</h5>
                                </div>
                            </div>
                            <div class="l_product_item">
                                <div class="l_p_img">
                                    <img src="img/product/l-product-1.png" alt="">
                                </div>
                                <div class="l_p_text">
                                   <ul>
                                        <li><a class="add_cart_btn" href="#">Adicionar ao Carrinho</a></li>
                        ...
                        <div class="item">
                            <div class="l_product_item">
                                <div class="l_p_img">
                                    <a href="product-details3.html"><img src="img/product/l-product-2.png" alt=""></a>
                                </div>
                                <div class="l_p_text">
                                   <ul>
                                        <li><a class="add_cart_btn" href="#">Adicionar ao Carrinho</a></li>
                            ...
                            <div class="l_product_item">
                                <div class="l_p_img">
                                    <img src="img/product/l-product-2.png" alt="">
                                </div>
                                <div class="l_p_text">
                                   <ul>
                                        <li><a class="add_cart_btn" href="#">Adicionar ao Carrinho</a></li>
